...
│ --verbose             -v                INTEGER RANGE [0<=x<=3]  Verbosity (nothing=ERROR,       │
│                                                                  -v=WARNING, -vv=INFO,           │
│                                                                  -vvv=DEBUG).                    │
│                                                                                      │
│ --color                   --no-color                             Force enable/disable colored    │
│                                                                  output (respects NO_COLOR env   │
│                                                                  var if not provided). Defaults  │
│                                                                  to having colors.               │
