...
- [poetrycli — Python 3.12-14 Poetry CLI Template (Typer + Rich + Ruff + MyPy)](#poetrycli--python-312-14-poetry-cli-template-typer--rich--ruff--mypy)
  ...
  - [How to make a new project from this template](#how-to-make-a-new-project-from-this-template)
  ...
  - [Features explained](#features-explained)
    ...
    - [Notes on templates](#notes-on-templates)
...
Install Poetry with `pipx` and configure poetry to create `.venv/` locally. This template expects a project-local virtual environment at `./.venv` (VSCode settings assume it):
...
## How to make a new project from this template

This repo includes many `# TODO:` markers to guide you. The fastest checklist is:
...
After changing versions, re-create your venv:
