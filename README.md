...
- [poetrycli - Python/Poetry/Typer/Rich CLI Template](#poetrycli---pythonpoetrytyperrich-cli-template)
  ...
  - [Appendix **I**: Using the `poetrycli` template](#appendix-i-using-the-poetrycli-template)
    - [New Projects](#new-projects)
      ...
      - [Pick a Python version (skip if 3.13 is good)](#pick-a-python-version-skip-if-313-is-good)
...
sudo apt-get update
sudo apt-get install python3.13  # or python3.13 or python3.14 - TODO: pick a version
```
...
brew install git python@3.13  # or python3.13 or python3.14 - TODO: pick a version
```
...
```sh
poetry env use python3.13  # creates the .venv with the correct Python version - TODO: pick correct Python version
...
#### Pick a Python version (skip if 3.13 is good)

This template currently targets **Python 3.13** (or **Python 3.12** or **Python 3.14**). It may possibly work with more versions, but these ones the authors have tested. If you want a different Python version, update the “Python version cluster” in multiple places, *at least* update all of these:

- `pyproject.toml`:
  - [project.classifiers] (e.g., "Programming Language :: Python :: 3.13")
  - [project.requires-python] (e.g., ">=3.13")
  - [tool.poetry.dependencies].python (e.g., "^3.13")
  - [tool.ruff].target-version (e.g., "py313")
  - [tool.mypy].python_version (e.g., "3.13")
  - [tool.pyright].pythonVersion (e.g., "3.13")
...
- Install **Python 3.13** (or your chosen target version).
...
- `requires-python = ">=3.13"` (or your chosen version)
